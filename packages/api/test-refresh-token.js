...
async function testRefreshToken() {
  ...
  try {
    ...
    console.log('   - Session Token 过期时间:', new Date(loginData.session_expires_at).toLocaleString());
    console.log('   - Refresh Token 过期时间:', new Date(loginData.refresh_expires_at).toLocaleString());
    ...
    if (refreshResponse.ok) {
      ...
      console.log('   - 新的 Session Token 过期时间:', new Date(refreshData.session_expires_at).toLocaleString());
    } else {
