...
export type GetMyChatSessionsQuery = {
  __typename?: "Query";
  myChatSessions?: Array<{
    __typename?: "ChatSession";
    id?: string | null;
    title?: string | null;
...
export type DeleteChatSessionMutation = {
  __typename?: "Mutation";
  deleteChatSession?: boolean | null;
};
...
export type RecipeBasicFieldsFragment = {
  __typename?: "Recipe";
  id?: string | null;
  name?: string | null;
  servings?: number | null;
...
export type GetRecipePreferencesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetRecipePreferencesQuery = {
  __typename?: "Query";
  myRecipePreferences?: Array<{
    __typename?: "RecipePreference";
    id?: string | null;
...
export type SetRecipePreferenceMutation = {
  __typename?: "Mutation";
  setRecipePreference?: {
    __typename?: "RecipePreference";
    id?: string | null;
...
export type RemoveRecipePreferenceMutation = {
  __typename?: "Mutation";
  removeRecipePreference?: boolean | null;
};
...
export type GenerateRecipeMutation = {
  __typename?: "Mutation";
  generateRecipe?: {
    __typename?: "Recipe";
    id?: string | null;
...
export type TagCategoryFieldsFragment = {
  __typename?: "TagCategory";
  id?: string | null;
  name?: string | null;
  description?: string | null;
...
export type GetTagCategoriesQuery = {
  __typename?: "Query";
  tagCategories?: Array<{
    __typename?: "TagCategory";
    id?: string | null;
...
export type GetTagConflictsQuery = {
  __typename?: "Query";
  tagConflicts?: Array<{
    __typename?: "TagConflict";
    id?: string | null;
...
export type CheckTagConflictsQuery = {
  __typename?: "Query";
  checkTagConflicts?: string | null;
};
...
export const useGetMeQuery = <TData = GetMeQuery, TError = unknown>(
  ...
  return useQuery<GetMeQuery, TError, TData>({
    ...
    queryFn: fetcher<GetMeQuery, GetMeQueryVariables>(
      client,
      GetMeDocument,
      variables,
      headers,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<UserByUsernameQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<UserByUsernameQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<UserByUsernameQuery, TError, TData>({
    queryKey: ["UserByUsername", variables],
    queryFn: fetcher<UserByUsernameQuery, UserByUsernameQueryVariables>(
      client,
...
useUserByUsernameQuery.getKey = (variables: UserByUsernameQueryVariables) => [
  "UserByUsername",
  variables,
];

useUserByUsernameQuery.fetcher = (
  client: GraphQLClient,
  variables: UserByUsernameQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<UserByUsernameQuery, UserByUsernameQueryVariables>(
    client,
    UserByUsernameDocument,
    variables,
    headers,
...
export const useWechatLoginMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    WechatLoginMutation,
    TError,
  ...
  >({
    ...
    mutationFn: (variables?: WechatLoginMutationVariables) =>
      fetcher<WechatLoginMutation, WechatLoginMutationVariables>(
        client,
        WechatLoginDocument,
        variables,
        headers,
...
useWechatLoginMutation.fetcher = (
  client: GraphQLClient,
  variables: WechatLoginMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<WechatLoginMutation, WechatLoginMutationVariables>(
    client,
...
export const useRefreshSessionMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >({
    ...
    mutationFn: (variables?: RefreshSessionMutationVariables) =>
      fetcher<RefreshSessionMutation, RefreshSessionMutationVariables>(
        client,
...
useRefreshSessionMutation.fetcher = (
  client: GraphQLClient,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMyChatSessionsQuery, TError, TData>,
    "queryKey"
  > & {
  ...
  return useQuery<GetMyChatSessionsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetMyChatSessions"]
        : ["GetMyChatSessions", variables],
    queryFn: fetcher<GetMyChatSessionsQuery, GetMyChatSessionsQueryVariables>(
      client,
      GetMyChatSessionsDocument,
      variables,
      headers,
    ),
    ...options,
...
useGetMyChatSessionsQuery.getKey = (
  variables?: GetMyChatSessionsQueryVariables,
) =>
  variables === undefined
    ? ["GetMyChatSessions"]
...
useGetMyChatSessionsQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetMyChatSessionsQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetMyChatSessionsQuery, GetMyChatSessionsQueryVariables>(
    client,
    GetMyChatSessionsDocument,
    variables,
    headers,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetChatSessionQuery, TError, TData>,
    "queryKey"
  > & {
...
useGetChatSessionQuery.getKey = (variables: GetChatSessionQueryVariables) => [
  "GetChatSession",
  variables,
];
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateChatSessionMutationVariables) =>
...
useCreateChatSessionMutation.fetcher = (
  client: GraphQLClient,
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateChatSessionMutationVariables) =>
      fetcher<UpdateChatSessionMutation, UpdateChatSessionMutationVariables>(
        client,
...
useUpdateChatSessionMutation.fetcher = (
  client: GraphQLClient,
  variables: UpdateChatSessionMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<UpdateChatSessionMutation, UpdateChatSessionMutationVariables>(
    client,
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: DeleteChatSessionMutationVariables) =>
      fetcher<DeleteChatSessionMutation, DeleteChatSessionMutationVariables>(
        client,
...
useDeleteChatSessionMutation.fetcher = (
  client: GraphQLClient,
  variables: DeleteChatSessionMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<DeleteChatSessionMutation, DeleteChatSessionMutationVariables>(
    client,
...
export const useMyRecipesQuery = <TData = MyRecipesQuery, TError = unknown>(
  client: GraphQLClient,
  variables?: MyRecipesQueryVariables,
  options?: Omit<UseQueryOptions<MyRecipesQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<MyRecipesQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<MyRecipesQuery, TError, TData>({
    ...
    queryFn: fetcher<MyRecipesQuery, MyRecipesQueryVariables>(
      client,
      MyRecipesDocument,
      variables,
      headers,
...
useMyRecipesQuery.getKey = (variables?: MyRecipesQueryVariables) =>
  variables === undefined ? ["MyRecipes"] : ["MyRecipes", variables];

useMyRecipesQuery.fetcher = (
  client: GraphQLClient,
  variables?: MyRecipesQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<MyRecipesQuery, MyRecipesQueryVariables>(
    client,
    MyRecipesDocument,
    variables,
    headers,
...
export const useGetRecipeQuery = <TData = GetRecipeQuery, TError = unknown>(
  client: GraphQLClient,
  variables: GetRecipeQueryVariables,
  options?: Omit<UseQueryOptions<GetRecipeQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetRecipeQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<GetRecipeQuery, TError, TData>({
    queryKey: ["GetRecipe", variables],
    queryFn: fetcher<GetRecipeQuery, GetRecipeQueryVariables>(
      client,
      GetRecipeDocument,
      variables,
      headers,
...
useGetRecipeQuery.getKey = (variables: GetRecipeQueryVariables) => [
  "GetRecipe",
  variables,
];

useGetRecipeQuery.fetcher = (
  client: GraphQLClient,
  variables: GetRecipeQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetRecipeQuery, GetRecipeQueryVariables>(
    client,
    GetRecipeDocument,
    variables,
    headers,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetRecipePreferencesQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
  ...
  return useQuery<GetRecipePreferencesQuery, TError, TData>({
    queryKey:
      variables === undefined
        ...
        : ["GetRecipePreferences", variables],
    queryFn: fetcher<
      GetRecipePreferencesQuery,
      GetRecipePreferencesQueryVariables
    >(client, GetRecipePreferencesDocument, variables, headers),
    ...options,
  });
};

useGetRecipePreferencesQuery.getKey = (
  variables?: GetRecipePreferencesQueryVariables,
) =>
  variables === undefined
    ? ["GetRecipePreferences"]
...
useGetRecipePreferencesQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetRecipePreferencesQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetRecipePreferencesQuery, GetRecipePreferencesQueryVariables>(
    client,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetMyRecipesQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetMyRecipesQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<GetMyRecipesQuery, TError, TData>({
    queryKey:
      variables === undefined ? ["GetMyRecipes"] : ["GetMyRecipes", variables],
    queryFn: fetcher<GetMyRecipesQuery, GetMyRecipesQueryVariables>(
      client,
...
useGetMyRecipesQuery.getKey = (variables?: GetMyRecipesQueryVariables) =>
  variables === undefined ? ["GetMyRecipes"] : ["GetMyRecipes", variables];

useGetMyRecipesQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetMyRecipesQueryVariables,
  headers?: RequestInit["headers"],
) =>
...
export const useCreateRecipeMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateRecipeMutationVariables) =>
...
useCreateRecipeMutation.fetcher = (
  client: GraphQLClient,
...
export const useUpdateRecipeMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateRecipeMutationVariables) =>
...
useUpdateRecipeMutation.fetcher = (
  client: GraphQLClient,
...
export const useDeleteRecipeMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: DeleteRecipeMutationVariables) =>
...
useDeleteRecipeMutation.fetcher = (
  client: GraphQLClient,
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: SetRecipePreferenceMutationVariables) =>
      fetcher<
        SetRecipePreferenceMutation,
        SetRecipePreferenceMutationVariables
      >(client, SetRecipePreferenceDocument, variables, headers)(),
    ...options,
  });
};

useSetRecipePreferenceMutation.fetcher = (
  client: GraphQLClient,
  variables: SetRecipePreferenceMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<SetRecipePreferenceMutation, SetRecipePreferenceMutationVariables>(
    client,
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    RemoveRecipePreferenceMutation,
    TError,
    RemoveRecipePreferenceMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) => {
  ...
  >({
    ...
    mutationFn: (variables?: RemoveRecipePreferenceMutationVariables) =>
      fetcher<
        RemoveRecipePreferenceMutation,
        RemoveRecipePreferenceMutationVariables
      >(client, RemoveRecipePreferenceDocument, variables, headers)(),
    ...options,
  });
};

useRemoveRecipePreferenceMutation.fetcher = (
  client: GraphQLClient,
  variables: RemoveRecipePreferenceMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<
    RemoveRecipePreferenceMutation,
...
export const useGenerateRecipeMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >({
    ...
    mutationFn: (variables?: GenerateRecipeMutationVariables) =>
      fetcher<GenerateRecipeMutation, GenerateRecipeMutationVariables>(
        client,
...
useGenerateRecipeMutation.fetcher = (
  client: GraphQLClient,
  variables: GenerateRecipeMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GenerateRecipeMutation, GenerateRecipeMutationVariables>(
    client,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<RecipesByIdsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<RecipesByIdsQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<RecipesByIdsQuery, TError, TData>({
    queryKey: ["RecipesByIds", variables],
    queryFn: fetcher<RecipesByIdsQuery, RecipesByIdsQueryVariables>(
      client,
      RecipesByIdsDocument,
      variables,
      headers,
    ),
    ...options,
...
useRecipesByIdsQuery.getKey = (variables: RecipesByIdsQueryVariables) => [
  "RecipesByIds",
  variables,
];

useRecipesByIdsQuery.fetcher = (
  client: GraphQLClient,
  variables: RecipesByIdsQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<RecipesByIdsQuery, RecipesByIdsQueryVariables>(
    client,
    RecipesByIdsDocument,
    variables,
    headers,
...
export const useDeleteRecipesMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    DeleteRecipesMutation,
    TError,
    DeleteRecipesMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"],
) => {
  ...
  >({
    ...
    mutationFn: (variables?: DeleteRecipesMutationVariables) =>
      fetcher<DeleteRecipesMutation, DeleteRecipesMutationVariables>(
        client,
        DeleteRecipesDocument,
        variables,
        headers,
      )(),
    ...options,
...
useDeleteRecipesMutation.fetcher = (
  client: GraphQLClient,
  variables: DeleteRecipesMutationVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<DeleteRecipesMutation, DeleteRecipesMutationVariables>(
    client,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetTagCategoriesQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
  ...
  return useQuery<GetTagCategoriesQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetTagCategories"]
        : ["GetTagCategories", variables],
    queryFn: fetcher<GetTagCategoriesQuery, GetTagCategoriesQueryVariables>(
      client,
      GetTagCategoriesDocument,
      variables,
      headers,
    ),
    ...options,
...
useGetTagCategoriesQuery.getKey = (
  variables?: GetTagCategoriesQueryVariables,
) =>
  variables === undefined
    ? ["GetTagCategories"]
...
useGetTagCategoriesQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetTagCategoriesQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetTagCategoriesQuery, GetTagCategoriesQueryVariables>(
    client,
    GetTagCategoriesDocument,
    variables,
    headers,
...
export const useGetTagQuery = <TData = GetTagQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<GetTagQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetTagQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<GetTagQuery, TError, TData>({
    queryKey: ["GetTag", variables],
    queryFn: fetcher<GetTagQuery, GetTagQueryVariables>(
      client,
      GetTagDocument,
      variables,
      headers,
...
useGetTagQuery.getKey = (variables: GetTagQueryVariables) => [
  "GetTag",
  variables,
];

useGetTagQuery.fetcher = (
  client: GraphQLClient,
  variables: GetTagQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetTagQuery, GetTagQueryVariables>(
    client,
    GetTagDocument,
    variables,
    headers,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetTagConflictsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<GetTagConflictsQuery, TError, TData>["queryKey"];
  },
  headers?: RequestInit["headers"],
) => {
  return useQuery<GetTagConflictsQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ["GetTagConflicts"]
        : ["GetTagConflicts", variables],
    queryFn: fetcher<GetTagConflictsQuery, GetTagConflictsQueryVariables>(
      client,
      GetTagConflictsDocument,
      variables,
      headers,
    ),
    ...options,
...
useGetTagConflictsQuery.getKey = (variables?: GetTagConflictsQueryVariables) =>
  variables === undefined
    ? ["GetTagConflicts"]
    : ["GetTagConflicts", variables];

useGetTagConflictsQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetTagConflictsQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<GetTagConflictsQuery, GetTagConflictsQueryVariables>(
    client,
    GetTagConflictsDocument,
    variables,
    headers,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CheckTagConflictsQuery, TError, TData>,
    "queryKey"
  > & {
    queryKey?: UseQueryOptions<
      CheckTagConflictsQuery,
      TError,
      TData
    >["queryKey"];
  },
  ...
  return useQuery<CheckTagConflictsQuery, TError, TData>({
    ...
    queryFn: fetcher<CheckTagConflictsQuery, CheckTagConflictsQueryVariables>(
      client,
      CheckTagConflictsDocument,
      variables,
      headers,
    ),
    ...options,
...
useCheckTagConflictsQuery.getKey = (
  variables: CheckTagConflictsQueryVariables,
) => ["CheckTagConflicts", variables];

useCheckTagConflictsQuery.fetcher = (
  client: GraphQLClient,
  variables: CheckTagConflictsQueryVariables,
  headers?: RequestInit["headers"],
) =>
  fetcher<CheckTagConflictsQuery, CheckTagConflictsQueryVariables>(
    client,
    CheckTagConflictsDocument,
    variables,
    headers,
...
export const useCreateTagMutation = <TError = unknown, TContext = unknown>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateTagMutationVariables) =>
